...
static const uint _LINEAR_BORDER_BLACK_INDEX    = 7;
static const uint _LINEAR_BORDER_WHITE_INDEX    = 8;

static const uint _SAMPLER_STATE_MAX = _LINEAR_BORDER_WHITE_INDEX + 1;
