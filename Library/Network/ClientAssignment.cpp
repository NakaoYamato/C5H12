...
#endif // USE_MRS
{
	...
	case Network::DataTag::PlayerSetLeader:
	{
		...
		{
			self->_logs.push_back(u8"\t読み取り失敗:SetLeader");
			return;
		}
	...
	case Network::DataTag::PlayerApplyDamage:
	{
		...
		{
			self->_logs.push_back(u8"\t読み取り失敗:ApplyDamage");
			return;
		}
	...
	case Network::DataTag::EnemyCreate:
	{
		...
		{
			self->_logs.push_back(u8"\t読み取り失敗:EnemyCreate");
			return;
		}
	...
	case Network::DataTag::EnemySync:
	{
		...
		{
			self->_logs.push_back(u8"\t読み取り失敗:EnemySync");
			return;
		}
	...
	case Network::DataTag::EnemyMove:
	{
		...
		{
			self->_logs.push_back(u8"\t読み取り失敗:EnemyMove");
			return;
		}
	...
	case Network::DataTag::EnemyApplayDamage:
	{
		...
		{
			self->_logs.push_back(u8"\t読み取り失敗:EnemyApplayDamage");
			return;
		}
