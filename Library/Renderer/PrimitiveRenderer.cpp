...
{
public:
	PrimitiveRendererData(ID3D11Device* device)
	{
...
{
	std::unique_ptr<PrimitiveRendererData> primitiveRenderer;

	void Initialize(ID3D11Device* device)
	{
		primitiveRenderer = std::make_unique<PrimitiveRendererData>(device);
	}
	...
	{
		primitiveRenderer->Render(dc, view, projection);
	}
