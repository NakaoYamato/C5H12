...
class QuestClearUIController : public Component
{
public:
	QuestClearUIController() {}
	~QuestClearUIController() override {}
	// 名前取得
	const char* GetName() const override { return "QuestClearUIController"; }
	// 開始処理
	void Start() override;
	// 更新処理
